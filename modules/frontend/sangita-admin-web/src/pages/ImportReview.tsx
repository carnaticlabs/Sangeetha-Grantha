...
interface ResolutionResult {
  composerCandidates: ResolutionCandidate<{ id: string; name: string }>[];
  ragaCandidates: ResolutionCandidate<{ id: string; name: string }>[];
  talaCandidates: ResolutionCandidate<{ id: string; name: string }>[];
  resolved: boolean;
}
        ...
        <div className="mt-4 p-3 bg-indigo-50 border border-indigo-100 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    {resolution.composerCandidates.length === 0 ? <span className="text-xs italic text-gray-400">No matches</span> : (
                ...
                <div>
                    ...
                    {resolution.ragaCandidates.length === 0 ? <span className="text-xs italic text-gray-400">No matches</span> : (
                        <div className="flex flex-col gap-1">
                ...
                {loading ? (
                    ...
                    imports.map(item => (
                        <div 
                            ...
                            className={`p-3 border-b border-border-light cursor-pointer hover:bg-slate-50 ${selectedId === item.id ? 'bg-primary-50 border-l-4 border-l-primary' : 'border-l-4 border-l-transparent'}`}
                        >
