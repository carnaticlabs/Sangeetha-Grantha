                                ...
                                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div>
                                                <label htmlFor="curator-lyrics-preview" className="block text-xs font-semibold text-ink-600 mb-1">Lyrics Preview</label>
                                                <textarea id="curator-lyrics-preview" value={overrideLyrics} onChange={e => setOverrideLyrics(e.target.value)}
                                                    rows={16}
