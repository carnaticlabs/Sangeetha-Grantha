...
object RasikaCopy {
    ...
    const val SEARCH_IDLE = "Find a known kriti or explore an idea. Try a title, a line of sahitya, or a theme such as Kamalamba Navavarna."
    ...
    const val TOP_MATCHES = "Top matches"
    const val SEARCH_OPTIONS = "Search options"
    const val HIDE_SEARCH_OPTIONS = "Hide options"
    const val SEARCH_HYBRID_HINT = "Search titles, lyrics and meaning together."
    const val SEARCH_SEMANTIC_HINT = "Explore related themes and ideas."
    const val SEARCH_LEXICAL_HINT = "Find words in the catalogue, with rāga and composer filters."
    const val DISCOVERY_SAVED_FILTERS = "Your saved filters apply only to Titles & lyrics."
    const val MODE_LEXICAL = "Titles & lyrics"
    const val MODE_HYBRID = "All matches"
