...
| File | Change |
|:---|:---|
| `tools/pdf-extractor/src/diacritic_normalizer.py` | New — normalise garbled diacritics |
| `tools/pdf-extractor/tests/test_diacritic_normalizer.py` | New — unit tests |
| `tools/pdf-extractor/src/metadata_parser.py` | Normalise before regex; add garbled raga/tala patterns |
| `tools/pdf-extractor/src/structure_parser.py` | Add caran. am / caran.am section patterns |
| `tools/pdf-extractor/src/page_segmenter.py` | METADATA_LINE_PATTERN for garbled forms |
| `tools/pdf-extractor/src/worker.py` | Apply normalisation and name cleanup before CanonicalExtraction |
