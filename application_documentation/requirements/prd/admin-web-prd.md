...
- Create and edit Krithis and their metadata.
...
## 3.5 Import Review & Canonicalization
...
- Extend the API contract with admin endpoints, e.g.:
  ...
  - `GET /v1/admin/krithis/{id}` – Krithi detail + variants + tags.
